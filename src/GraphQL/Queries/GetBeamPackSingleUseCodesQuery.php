...
class GetBeamPackSingleUseCodesQuery extends Query
{
    ...
    {
        return [
            'name' => 'GetBeamPackSingleUseCodes',
            'description' => __('enjin-platform-beam::query.get_beam_pack_single_use_codes.description'),
        ];
    }
    ...
    {
        return GraphQL::paginate('BeamPack', 'BeamPackConnection');
    }
    ...
    public function resolve(
        ...
        return BeamPack::loadSelectFields($resolveInfo, $this->name)
            ->hasCode($args['code'])
            ->with('beam')
            ->claimable()
