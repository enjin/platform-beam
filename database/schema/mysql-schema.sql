...
DROP TABLE IF EXISTS `beam_batches`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `beam_batches` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `beam_type` varchar(255) NOT NULL DEFAULT 'TRANSFER_TOKEN',
  `completed_at` timestamp NULL DEFAULT NULL,
  `processed_at` timestamp NULL DEFAULT NULL,
  `transaction_id` bigint unsigned DEFAULT NULL,
  `collection_chain_id` varchar(255) DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `beam_batches_completed_at_index` (`completed_at`),
  KEY `beam_batches_processed_at_index` (`processed_at`),
  KEY `beam_batches_transaction_id_index` (`transaction_id`),
  KEY `beam_batches_collection_chain_id_index` (`collection_chain_id`),
  CONSTRAINT `beam_batches_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `beam_claims`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `beam_claims` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `token_chain_id` varchar(255) DEFAULT NULL,
  `collection_id` bigint unsigned NOT NULL,
  `beam_id` bigint unsigned NOT NULL,
  `wallet_public_key` varchar(255) DEFAULT NULL,
  `claimed_at` timestamp NULL DEFAULT NULL,
  `state` varchar(255) DEFAULT NULL,
  `code` varchar(255) DEFAULT NULL,
  `nonce` int unsigned DEFAULT NULL,
  `quantity` int unsigned NOT NULL DEFAULT '1',
  `type` varchar(255) NOT NULL DEFAULT 'TRANSFER_TOKEN',
  `attributes` json DEFAULT NULL,
  `beam_batch_id` bigint unsigned DEFAULT NULL,
  `ip_address` varchar(255) DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `beam_claims_token_chain_id_index` (`token_chain_id`),
  KEY `beam_claims_collection_id_index` (`collection_id`),
  KEY `beam_claims_beam_id_index` (`beam_id`),
  KEY `beam_claims_wallet_public_key_index` (`wallet_public_key`),
  KEY `beam_claims_code_index` (`code`),
  KEY `beam_claims_beam_batch_id_index` (`beam_batch_id`),
  CONSTRAINT `beam_claims_beam_batch_id_foreign` FOREIGN KEY (`beam_batch_id`) REFERENCES `beam_batches` (`id`),
  CONSTRAINT `beam_claims_beam_id_foreign` FOREIGN KEY (`beam_id`) REFERENCES `beams` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `beam_scans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `beam_scans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `beam_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `beam_scans_beam_id_index` (`beam_id`),
  KEY `beam_scans_wallet_public_key_index` (`wallet_public_key`),
  CONSTRAINT `beam_scans_beam_id_foreign` FOREIGN KEY (`beam_id`) REFERENCES `beams` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `beams` (
  ...
  `flags_mask` int unsigned NOT NULL DEFAULT '0',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `beams_code_unique` (`code`),
  KEY `beams_collection_chain_id_index` (`collection_chain_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (14,'2022_10_11_141639_create_beam_batches_table',1);
INSERT INTO `migrations` VALUES (15,'2022_10_12_115527_create_beams_table',1);
INSERT INTO `migrations` VALUES (16,'2022_10_12_115558_create_beam_claims_table',1);
INSERT INTO `migrations` VALUES (17,'2022_10_17_143652_create_beam_scans_table',1);
INSERT INTO `migrations` VALUES (18,'2022_10_22_131819_create_events_table',1);
INSERT INTO `migrations` VALUES (19,'2023_02_03_135022_create_pending_events_table',1);
...
INSERT INTO `migrations` VALUES (22,'2023_06_27_014433_add_collection_chain_id_to_beam_batches_table',1);
